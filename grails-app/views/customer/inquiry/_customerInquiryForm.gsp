                        ...
                        <div class="infowrap">
                            ...
                            <div class="col-xs-8 col-sm-8">
                                ...
                                <g:if test="${customerInstance?.type.id==1}">
                                    ...
                                    <dl class="dl-horizontal">
                                        <dt>Age</dt>
                                        <dd><g:formatNumber format="####" number="${(customerInstance?.branch?.runDate - customerInstance?.birthDate)/365.25}" /></dd>
                                    </dl>                                        
                                    </g:if>    
                                    <dl class="dl-horizontal">
                        ...
                        <legend class="section-header">Contact Information</legend>
                           ...
                           <div class="infowrap">
                            ...
                            <div class="col-xs-8 col-sm-8">
                                ...
                                <dl class="dl-horizontal">
                                    <dt>View More Addresses</dt>
                                    <dd><g:if test="${customerInstance?.addresses?.size()>0}"><button type="button" class="btn btn-primary" onclick="openMoreAddresses()">View All Addresses</button></g:if><g:else><button class="btn btn-primary" disabled="disabled">View More Addresses</button></g:else>
                                    </dd>
