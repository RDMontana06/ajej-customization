...
<div id="employment${i}" class="employment-div">
        ...
        <div class="form-group fieldcontain ${hasErrors(bean: customerInstance, field: 'employments['+i+'].distributionId', 'has-error')} ">
                <label class="control-label col-sm-4"for="employments[${i}].distributionId">
                        <g:message code="employment.distributionId.label" default="Gov't Distribution Id" />

                </label>
                <div class="col-sm-8">
                    <g:textField name="employments[${i}].distributionId" maxlength="30" value="${employment?.distributionId}"class="form-control"/>
                     <g:hasErrors bean="${customerInstance}" field="employments[${i}].distributionId">
                        <div class="controls">
                            <span class="help-block">
                                <g:eachError bean="${customerInstance}" field="employments[${i}].distributionId">
                                    <g:message error="${it}" /><br/>
                                </g:eachError>
                            </span>
                        </div>
...
<div class="form-group fieldcontain ${hasErrors(bean: customerInstance, field: 'employments['+i+'].region', 'has-error')} ">
	...
	<div class="col-sm-8"><g:select name="employments[${i}].region.id" from="${icbs.lov.Lov.findAllByGroupCodeAndStatus("RGN",true)}" optionKey="id" optionValue ="itemValue" value="${employment?.region?.id}"class="form-control" noSelection="['null': '']"/></div>
...
-->
                ...
                <label class="control-label col-sm-4"for="employments[${i}].monthlyIncome">
                        <g:message code="employment.monthlyIncome.label" default="Monthly Income" />
                </label>
                <div class="col-sm-8">
                    <g:textField name="employments[${i}].monthlyIncome" maxlength="30" value="${employment?.monthlyIncome}"class="form-control"/>
