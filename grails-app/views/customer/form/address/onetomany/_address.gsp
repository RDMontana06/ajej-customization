...
<div id="address${i}" class="address-div">
	...
	<div class="col-sm-8">
            <g:textField placeholder="Room No./Office Name, Bldg/House No., Street "name="addresses[${i}].address1" maxlength="250" value="${address?.address1}"class="form-control"/>
	...
	<div class="col-sm-8">
            <g:textField placeholder="Subd/Barangay/City" name="addresses[${i}].address2" maxlength="250" value="${address?.address2}"class="form-control"/>
         ...
         <div class="form-group fieldcontain ${hasErrors(bean: customerInstance, field: 'addresses['+i+'].town', 'has-error')} ">
                <label class="control-label col-sm-4"for="addresses[${i}].town">
                        <g:message code="address.region.label" default="Atolls/Country" />
                </label>
                <div class="col-sm-8">
                    <g:select noSelection="['null':'Atolls/Country']" name="addresses[${i}].town.id" from="${icbs.lov.Town.list()}" optionKey="id" value="${address?.town?.id}" class="form-control"/>
	...
	<div class="col-sm-8">
            <g:textField name="addresses[${i}].address3" maxlength="250" value="${address?.address3}"class="form-control"/>
   ...
   <div class="form-group fieldcontain ${hasErrors(bean: customerInstance, field: 'addresses['+i+'].residenceSince', 'has-error')} ">
	<label class="control-label col-sm-4" for="addresses[${i}].residenceSince">
		<g:message code="address.residenceSince.label" default="Residence Since" />
		
	</label>
	<div class="col-sm-8">
            <g:textField name="addresses[${i}].residenceSince" maxlength="25" value="${address?.residenceSince}"class="form-control"/>
            <g:hasErrors bean="${customerInstance}" field="addresses[${i}].residenceSince">
                <div class="controls">
                    <span class="help-block">
                        <g:eachError bean="${customerInstance}" field="addresses[${i}].residenceSince">
                            <g:message error="${it}" /><br/>
                        </g:eachError>
                    </span>
                </div>
