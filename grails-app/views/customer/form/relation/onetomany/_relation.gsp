...
<div id="relation${i}" class="relation-div" >
        ...
        <div class="form-group fieldcontain ${hasErrors(bean: customerInstance, field: 'relations['+i+'].customer2.civilStatus', 'has-error')} ">
            ...
            <div class="col-sm-8">
                <g:select disabled="${disabled}" name='relations[${i}].customer2.civilStatus.id' from="${icbs.lov.Lov.findAllByGroupCodeAndStatusAndIdNotEqual("CS",true,['0'])}" optionKey="id" optionValue ="itemValue" value="${relation?.customer2?.civilStatus?.id}" class="form-control" noSelection="['null': '']"/>
