				...
				$.ajax({
				    ...
				    success: function(msg){						
						...
						$('#applicationDate').val($(msg).find('#loan-application-date').html());
                                                if ($(msg).find('#loan-application-status').html() != '') {
                                                    if ($(msg).find('#loan-application-status').html() != 'Approved by Credit Com | APCC') {
                                                        //alert('Loan Application not yet approved');
                                                        alertify.alert(AppTitle,'Loan Application not yet approved');
                                                    }
                                                }    
                                                //alert(msg)
						updateSchemes();
            ...
            <ul>
               ...
               -->
                <li><g:submitButton id="save" name="save" value="Save" onclick="
                        alertify.confirm(AppTitle,'Are you sure you want to create this loan?',
                                function(){
                                    checkIfAllowed('LON00500', 'form#loan-form', 'Open New Loan', null);;
                                },
                                function(){
                                    return;
                                }); 
