...
<div class="table-responsive">
    ...
    <div class="fieldcontain form-group">
        <label class="control-label col-sm-4">
            <g:message code="loan.overduePrincipalBalance.label" default="Principal Amount Due" />
        </label>

        <span><g:formatNumber format="###,##0.00" number="${loanInstance?.overduePrincipalBalance}" /></span>
        <span></span>
    </div>         
    <div class="fieldcontain form-group">
        <label class="control-label col-sm-4">
            <g:message code="loan.balanceAmount.label" default="Total Amount Due" />
        </label>

        <span><g:formatNumber format="###,##0.00" number="${loanInstance?.overduePrincipalBalance + loanInstance?.interestBalanceAmount + loanInstance?.penaltyBalanceAmount + loanInstance?.serviceChargeBalanceAmount}" /></span>
        <span></span>
    </div>        
</div>
