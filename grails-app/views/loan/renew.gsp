...
<html>
	<head>
		...
		<g:if test="${module == 'loanRenewal'}">
        	<title>Renew Loan Account ${loanInstance?.accountNo} (${loanInstance?.customer?.displayName}) </title>
        </g:if>
        <g:elseif test="${module == 'loanROPA'}">
        	<title>Create Sales Contract Receivable</title>
        </g:elseif>
		<g:javascript>
                        function int() 
                            {
	...
	<body>
		...
		<div id="edit-loan" class="content scaffold-edit" role="main">
			...
			<g:form id="loan-form" url="[resource:loanInstance, action:'saveNew']">
				<g:hiddenField name="version" value="${loanInstance?.version}" />
				<g:hiddenField name="activity" value="Renewal" />
                ...
                <div class="tab-content">
					...
					<div class="tab-pane" id="tab_5">
						<g:render template="deductions/listRenew"/>
					</div>
