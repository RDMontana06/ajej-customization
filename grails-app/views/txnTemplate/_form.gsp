...
<div class="fieldcontain form-group ${hasErrors(bean: txnTemplateInstance, field: 'txnModule', 'has-error')} required">
	...
	<div class="col-sm-8"><g:select id="txnModule" name="txnModule.id" from="${icbs.lov.TxnModule.list()}" optionKey="id" required="" value="${txnTemplateInstance?.txnModule?.id}" class="many-to-one form-control"/>
...
<div class="fieldcontain form-group ${hasErrors(bean: txnTemplateInstance, field: 'txnType', 'has-error')} required">
	...
	<div class="col-sm-8"><g:select id="txnType" name="txnType.id" from="${icbs.lov.TxnType.list()}" optionKey="id" required="" value="${txnTemplateInstance?.txnType?.id}" class="many-to-one form-control"/>
...
<div class="fieldcontain form-group ${hasErrors(bean: txnTemplateInstance, field: 'code', 'has-error')} required">
	...
	<div class="col-sm-8"><g:textField name="code" maxlength="50" required="" value="${txnTemplateInstance?.code}"class="form-control"/>
...
<div class="fieldcontain form-group ${hasErrors(bean: txnTemplateInstance, field: 'description', 'has-error')} required">
	...
	<div class="col-sm-8"><g:textField name="description" maxlength="100" required="" value="${txnTemplateInstance?.description}"class="form-control"/>
...
<div class="fieldcontain form-group ${hasErrors(bean: txnTemplateInstance, field: 'shortDescription', 'has-error')} ">
	...
	<div class="col-sm-8"><g:textField name="shortDescription" maxlength="50" value="${txnTemplateInstance?.shortDescription}"class="form-control"/>
...
<div class="fieldcontain form-group ${hasErrors(bean: txnTemplateInstance, field: 'minAmt', 'has-error')} ">
	...
	<div class="col-sm-8"><g:field name="minAmt" value="${fieldValue(bean: txnTemplateInstance, field: 'minAmt')}" class="form-control"/>
...
<div class="fieldcontain form-group ${hasErrors(bean: txnTemplateInstance, field: 'maxAmt', 'has-error')} ">
	...
	<div class="col-sm-8"><g:field name="maxAmt" value="${fieldValue(bean: txnTemplateInstance, field: 'maxAmt')}" class="form-control"/>
...
<div class="fieldcontain form-group ${hasErrors(bean: txnTemplateInstance, field: 'amlaCode', 'has-error')} ">
	...
	<div class="col-sm-8"><g:textField name="amlaCode" maxlength="10" value="${txnTemplateInstance?.amlaCode}"class="form-control"/>
...
<div class="fieldcontain form-group ${hasErrors(bean: txnTemplateInstance, field: 'requireTxnDescription', 'has-error')} ">
	...
	<div class="col-sm-8"><g:checkBox name="requireTxnDescription" class="form-control" value="${txnTemplateInstance?.requireTxnDescription}" />
...
<div class="fieldcontain form-group ${hasErrors(bean: txnTemplateInstance, field: 'requireTxnReference', 'has-error')} ">
	...
	<div class="col-sm-8"><g:checkBox name="requireTxnReference" class="form-control" value="${txnTemplateInstance?.requireTxnReference}" />
...
<div class="fieldcontain form-group ${hasErrors(bean: txnTemplateInstance, field: 'validationCopyNo', 'has-error')} ">
	...
	<div class="col-sm-8"><g:field name="validationCopyNo" type="number" value="${txnTemplateInstance.validationCopyNo}" class="form-control"/>
...
<div class="fieldcontain form-group ${hasErrors(bean: txnTemplateInstance, field: 'validationFormCode', 'has-error')} ">
	<label class="control-label col-sm-4" for="validationFormCode">
		<g:message code="txnTemplate.validationFormCode.label" default="Validation Form Code" />
		
	</label>
	<div class="col-sm-8"><g:textField name="validationFormCode" value="${txnTemplateInstance?.validationFormCode}"class="form-control"/>
...
<div class="fieldcontain form-group ${hasErrors(bean: txnTemplateInstance, field: 'currency', 'has-error')} ">
	...
	<div class="col-sm-8"><g:select id="currency" name="currency.id" from="${icbs.admin.Currency.findAll{configItemStatus.id == 2}}" optionKey="id" value="${txnTemplateInstance?.currency?.id}" class="many-to-one form-control" noSelection="['null': '']"/>
...
<div class="fieldcontain form-group ${hasErrors(bean: txnTemplateInstance, field: 'requirePassbook', 'has-error')} ">
	...
	<div class="col-sm-8"><g:select id="requirePassbook" name="requirePassbook.id" from="${icbs.lov.YesNoNa.list()}" optionKey="id" value="${txnTemplateInstance?.requirePassbook?.id}" class="many-to-one form-control" noSelection="['null': '']"/>
...
<div class="fieldcontain form-group ${hasErrors(bean: txnTemplateInstance, field: 'atmOnlyTxn', 'has-error')} required">
	<label class="control-label col-sm-4" for="atmOnlyTxn">
		<g:message code="txnTemplate.atmOnlyTxn.label" default="Atm Only Txn" />
		<span class="required-indicator">*</span>
	</label>
	<div class="col-sm-8"><g:select id="atmOnlyTxn" name="atmOnlyTxn.id" from="${icbs.lov.YesNoNa.list()}" optionKey="id" required="" value="${txnTemplateInstance?.atmOnlyTxn?.id}" class="many-to-one form-control"/>
...
<div class="fieldcontain form-group ${hasErrors(bean: txnTemplateInstance, field: 'interbranchTxn', 'has-error')} required">
	...
	<div class="col-sm-8"><g:select id="interbranchTxn" name="interbranchTxn.id" from="${icbs.lov.YesNoNa.list()}" optionKey="id" required="" value="${txnTemplateInstance?.interbranchTxn?.id}" class="many-to-one form-control"/>
...
<div class="fieldcontain form-group ${hasErrors(bean: txnTemplateInstance, field: 'systemOnlyTxn', 'has-error')} ">
	...
	<div class="col-sm-8"><g:checkBox name="systemOnlyTxn" class="form-control" value="${txnTemplateInstance?.systemOnlyTxn}" />
...
<div class="fieldcontain form-group ${hasErrors(bean: txnTemplateInstance, field: 'memoTxnType', 'has-error')} required">
	...
	<div class="col-sm-8"><g:select id="memoTxnType" name="memoTxnType.id" from="${icbs.lov.MemoTxnType.list()}" optionKey="id" required="" value="${txnTemplateInstance?.memoTxnType?.id}" class="many-to-one form-control"/>
...
<div class="fieldcontain form-group ${hasErrors(bean: txnTemplateInstance, field: 'batchTxn', 'has-error')} required">
	...
	<div class="col-sm-8"><g:select id="batchTxn" name="batchTxn.id" from="${icbs.lov.YesNoNa.list()}" optionKey="id" required="" value="${txnTemplateInstance?.batchTxn?.id}" class="many-to-one form-control"/>
