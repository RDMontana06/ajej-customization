...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-group fieldcontain ${hasErrors(bean: adjustmentInstance, field: 'type', 'has-error')} ">
            ...
            <div class="col-sm-8">
                <g:select id="type" onchange="changeMemoForm('adjustment')" name="type.id" from="${icbs.lov.MemoType.findAllByStatus(true)}" optionKey="id" optionValue ="description" value="2"class="form-control"/>
        ...
        <div class="form-group fieldcontain ${hasErrors(bean: adjustmentInstance, field: 'txnTemplate', 'has-error')} ">
            ...
            <div class="col-sm-8">
                <g:select id="txnTemplate" name="txnTemplate.id" from="${icbs.admin.TxnTemplate.findAllByTxnType(icbs.lov.TxnType.read(9))}" optionKey="id" optionValue ="description" value="${adjustmentInstance?.txnTemplate?.id}"class="many-to-one form-control"/>
        ...
        <div class="form-group fieldcontain ${hasErrors(bean: adjustmentInstance, field: 'amt', 'has-error')} ">
            ...
            <div class="col-sm-8">
                <g:textField id="AdjustCreditAmt" name="amt" value="${adjustmentInstance?.amt}" class="form-control truncated"/>
        ...
        <div class="form-group fieldcontain ${hasErrors(bean: adjustmentInstance, field: 'txnRef', 'has-error')} ">
            ...
            <div class="col-sm-8">
                <g:textField id="AdjustCreditRef" name="txnRef" value="${adjustmentInstance?.txnRef}" class="form-control"/>
    ...
    <div class="col-md-6">
        <g:submitButton name="submit" class="btn btn-primary" id="submitFrmAdjust" style="display:none"/>
        <button class="btn btn-primary" id="submitFrmAdjustCredit">  Submit  </button>
        <script>
            $('#submitFrmAdjustCredit').on('click',function(f){
            f.preventDefault();
