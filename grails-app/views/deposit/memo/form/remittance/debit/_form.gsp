...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-group fieldcontain ${hasErrors(bean: remittanceInstance, field: 'txnTemplate', 'has-error')} ">
            ...
            <div class="col-sm-8">
                <g:select id="txnTemplate" name="txnTemplate.id" from="${icbs.admin.TxnTemplate.findAllByTxnTypeAndMemoTxnType(icbs.lov.TxnType.read(7),icbs.lov.MemoTxnType.read(2))}" optionKey="id" optionValue ="description" value="${adjustmentInstance?.txnTemplate?.id}"class="form-control"/>
