...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-group fieldcontain ${hasErrors(bean: billsPaymentInstance, field: 'txnTemplate', 'has-error')} ">
            ...
            <div class="col-sm-8">
                <g:select id="txnTemplate" name="txnTemplate.id" from="${icbs.admin.TxnTemplate.findAllByTxnTypeAndMemoTxnType(icbs.lov.TxnType.read(7),icbs.lov.MemoTxnType.read(3))}" optionKey="id" optionValue ="description" value="${billsPaymentInstance?.txnTemplate?.id}"class="form-control"/>
