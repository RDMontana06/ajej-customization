...
<div class="fieldcontain form-group ${hasErrors(bean: issuePassbookInstance, field: 'passbookNo', 'has-error')} required">
	...
	<div class="col-sm-8"><g:textField name="passbookNo" required="" value="${issuePassbookInstance?.passbook?.passbookNo}"class="form-control"/>
...
<div class="fieldcontain form-group ${hasErrors(bean: issuePassbookInstance, field: 'remarks', 'has-error')} ">
	...
	<div class="col-sm-8"><g:textArea name="remarks" cols="40" rows="5" maxlength="255" value="${issuePassbookInstance?.remarks}"class="form-control"/>
