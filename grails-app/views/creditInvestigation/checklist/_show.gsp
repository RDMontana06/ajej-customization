...
<div >
    ...
    <tr>
        <td>
            <div>
                <g:checkBox disabled="{disabled}" id="formA2" name="formA2" value="${creditInvestigationInstance?.formA2}"/>
    ...
    <tr>
        <td>
            <div>
                <g:checkBox disabled="{disabled}" id="formA3" name="formA3" value="${creditInvestigationInstance?.formA3}"/>
     ...
     <tr>
        <td>
            <div>
                <g:checkBox disabled="{disabled}" id="formA4" name="formA4" value="${creditInvestigationInstance?.formA4}"/>
    ...
    <tr>
        <td>
            <div>
                <g:checkBox disabled="{disabled}" id="formA5" name="formA5" value="${creditInvestigationInstance?.formA5}"/>
    ...
    <tr>
        <td>
            <div>
                <g:checkBox disabled="{disabled}" id="formA6" name="formA6" value="${creditInvestigationInstance?.formA6}"/>
    ...
    <tr>
        <td>
            <div>
                <g:checkBox disabled="{disabled}" id="formA7" name="formA7" value="${creditInvestigationInstance?.formA7}"/>
    ...
    <tr>
        <td>
            <div>
                <g:checkBox disabled="{disabled}" id="formA8" name="formA8" value="${creditInvestigationInstance?.formA8}"/>
    ...
    <tr>
        <td>
            <div>
                <g:checkBox disabled="{disabled}" id="formA9" name="formA9" value="${creditInvestigationInstance?.formA9}"/>
    ...
    <tr>
        <td>
            <div>
                <g:checkBox disabled="{disabled}" id="formA10" name="formA10" value="${creditInvestigationInstance?.formA10}"/>
    ...
    <tr>
        <td>
            <div>
                <g:checkBox disabled="{disabled}" id="formA11" name="formA11" value="${creditInvestigationInstance?.formA11}"/>
    ...
    <tr>
        <td>
            <div>
                <g:checkBox disabled="{disabled}" id="formA12" name="formA12" value="${creditInvestigationInstance?.formA12}"/>
    ...
    <tr>
        <td>
            <div>
                <g:checkBox disabled="{disabled}" id="formA13" name="formA13" value="${creditInvestigationInstance?.formA13}"/>
    ...
    <tr>
        <td>
            <div>
                <g:checkBox disabled="{disabled}" id="formA14" name="formA14" value="${creditInvestigationInstance?.formA14}"/>
    ...
    <tr>
        <td>
            <div>
                <g:checkBox disabled="{disabled}" id="formA15" name="formA15" value="${creditInvestigationInstance?.formA15}"/>
    ...
    <tr>
        <td>
            <div>
                <g:checkBox disabled="{disabled}" id="formA16" name="formA16" value="${creditInvestigationInstance?.formA16}"/>
    ...
    <tr>
        <td>
            <div>
                <g:checkBox disabled="{disabled}" id="formA17" name="formA17" value="${creditInvestigationInstance?.formA17}"/>
    ...
    <tr>
        <td>
            <div>
                <g:checkBox disabled="{disabled}" id="formA18" name="formA18" value="${creditInvestigationInstance?.formA18}"/>
    ...
    <tr>
        <td>
            <div>
                <g:checkBox disabled="{disabled}" id="formA19" name="formA19" value="${creditInvestigationInstance?.formA19}"/>
    ...
    <tr> 
        ...
        <td>
            <div>
                <g:textField disabled="{disabled}" id="formA20" name="formA20" value="${creditInvestigationInstance?.formA20}" maxlength="250" class="form-control"/>
    ...
    <tr>
        <td>
            <div>
                <g:checkBox disabled="{disabled}" id="formA21" name="formA21" value="${creditInvestigationInstance?.formA21}"/>
    ...
    <tr>
        <td>
            <div>
                <g:checkBox disabled="{disabled}" id="formA22" name="formA22" value="${creditInvestigationInstance?.formA22}"/>
    ...
    <tr>
        <td>
            <div>
                <g:checkBox disabled="{disabled}" id="formA23" name="formA23" value="${creditInvestigationInstance?.formA23}"/>
    ...
    <tr>
        <td>
            <div>
                <g:checkBox disabled="{disabled}" id="formA24" name="formA24" value="${creditInvestigationInstance?.formA24}"/>
    ...
    <tr>
        <td>
            <div>
                <g:checkBox disabled="{disabled}" id="formA25" name="formA25" value="${creditInvestigationInstance?.formA25}"/>
    ...
    <tr>
        <td>
            <div>
                <g:checkBox disabled="{disabled}" id="formA26" name="formA26" value="${creditInvestigationInstance?.formA26}"/>
    ...
    <tr>
        <td>
            <div>
                <g:checkBox disabled="{disabled}" id="formA27" name="formA27" value="${creditInvestigationInstance?.formA27}"/>
    ...
    <tr>
        <td>
            <div>
                <g:checkBox disabled="{disabled}" id="formA28" name="formA28" value="${creditInvestigationInstance?.formA28}"/>
    ...
    <tr>
        <td>
            <div>
                <g:checkBox disabled="{disabled}" id="formA29" name="formA29" value="${creditInvestigationInstance?.formA29}"/>
    ...
    <tr>
        <td>
            <div>
                <g:checkBox disabled="{disabled}" id="formA30" name="formA30" value="${creditInvestigationInstance?.formA30}"/>
    ...
    <tr>
        <td>
            <div>
                <g:checkBox disabled="{disabled}" id="formA31" name="formA31" value="${creditInvestigationInstance?.formA31}"/>
    ...
    <tr>
        <td>
            <div>
                <g:checkBox disabled="{disabled}" id="formA32" name="formA32" value="${creditInvestigationInstance?.formA32}"/>
    ...
    <tr>
        <td>
            <div>
                <g:checkBox disabled="{disabled}" id="formA33" name="formA33" value="${creditInvestigationInstance?.formA33}"/>
    ...
    <tr>
        <td>
            <div>
                <g:checkBox disabled="{disabled}" id="formA34" name="formA34" value="${creditInvestigationInstance?.formA34}"/>
    ...
    <tr>
        <td>
            <div>
                <g:checkBox disabled="{disabled}" id="formA35" name="formA35" value="${creditInvestigationInstance?.formA35}"/>
    ...
    <tr>
        <td>
            <div>
                <g:checkBox disabled="{disabled}" id="formA36" name="formA36" value="${creditInvestigationInstance?.formA36}"/>
    ...
    <tr>
        <td>
            <div>
                <g:checkBox disabled="{disabled}" id="formA37" name="formA37" value="${creditInvestigationInstance?.formA37}"/>
    ...
    <tr>
        <td>
            <div>
                <g:checkBox disabled="{disabled}" id="formA38" name="formA38" value="${creditInvestigationInstance?.formA38}"/>
    ...
    <table class="table table-hover table-condensed table-bordered table-striped">
            ...
            <tr>
                    ...
                    <td >
                            <div>
                                    <g:checkBox disabled="{disabled}" id="formB1" name="formB1" value="${creditInvestigationInstance?.formB1}"/>
            ...
            <tr>
                    ...
                    <td >
                            <div>
                                    <g:checkBox disabled="{disabled}" id="formB2" name="formB2" value="${creditInvestigationInstance?.formB2}"/>
            ...
            <tr>
                    ...
                    <td >
                            <div>
                                    <g:checkBox disabled="{disabled}" id="formB3" name="formB3" value="${creditInvestigationInstance?.formB3}"/>
            ...
            <tr>
                    ...
                    <td >
                            <div>
                                    <g:checkBox disabled="{disabled}" id="formB4" name="formB4" value="${creditInvestigationInstance?.formB4}"/>
            ...
            <tr>
                    ...
                    <td >
                            <div>
                                    <g:checkBox disabled="{disabled}" id="formB5" name="formB5" value="${creditInvestigationInstance?.formB5}"/>
            ...
            <tr>
                    ...
                    <td >
                            <div>
                                    <g:checkBox disabled="{disabled}" id="formB6" name="formB6" value="${creditInvestigationInstance?.formB6}"/>
            ...
            <tr>
                    ...
                    <td >
                            <div>
                                    <g:checkBox disabled="{disabled}" id="formB7" name="formB7" value="${creditInvestigationInstance?.formB7}"/>
            ...
            <tr>
                    ...
                    <td >
                            <div>
                                    <g:checkBox disabled="{disabled}" id="formB8" name="formB8" value="${creditInvestigationInstance?.formB8}"/>
            ...
            <tr>
                    ...
                    <td >
                            <div>
                                    <g:checkBox disabled="{disabled}" id="formB9" name="formB9" value="${creditInvestigationInstance?.formB9}"/>
            ...
            <tr>
                    ...
                    <td >
                            <div>
                                    <g:checkBox disabled="{disabled}" id="formB10" name="formB10" value="${creditInvestigationInstance?.formB10}"/>
            ...
            <tr>
                    ...
                    <td >
                            <div>
                                    <g:checkBox disabled="{disabled}" id="formB11" name="formB11" value="${creditInvestigationInstance?.formB11}"/>
            ...
            <tr>
                    ...
                    <td >
                            <div>
                                    <g:checkBox disabled="{disabled}" id="formB12" name="formB12" value="${creditInvestigationInstance?.formB12}"/>
            ...
            <tr>
                    ...
                    <td >
                            <div>
                                    <g:checkBox disabled="{disabled}" id="formB13" name="formB13" value="${creditInvestigationInstance?.formB13}"/>
            ...
            <tr>
                    ...
                    <td >
                            <div>
                                    <g:checkBox disabled="{disabled}" id="formB14" name="formB14" value="${creditInvestigationInstance?.formB14}"/>
            ...
            <tr>
                    ...
                    <td >
                            <div>
                                    <g:checkBox disabled="{disabled}" id="formB15" name="formB15" value="${creditInvestigationInstance?.formB15}"/>
            ...
            <tr>
                    ...
                    <td >
                            <div>
                                    <g:checkBox disabled="{disabled}" id="formB16" name="formB16" value="${creditInvestigationInstance?.formB16}"/>
            ...
            <tr>
                    ...
                    <td >
                            <div>
                                    <g:checkBox disabled="{disabled}" id="formB17" name="formB17" value="${creditInvestigationInstance?.formB17}"/>
            ...
            <tr>
                    ...
                    <td >
                            <div>
                                    <g:checkBox disabled="{disabled}" id="formB18" name="formB18" value="${creditInvestigationInstance?.formB18}"/>
