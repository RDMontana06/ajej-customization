        ...
        <div class="col-md-12">
            <div class="infowrap">
                 <table>
                     ...
                     <tr>
                       <td><div class="col-sm-12"><g:textArea name="proposal" cols="100" rows="25" value="${creditInvestigationInstance?.termsAndCondition}"class="form-control"/>
                     ...
                     <tr>
                       <td><div class="col-sm-12"><g:textArea name="termsAndCondition" cols="100" rows="25" value="${creditInvestigationInstance?.termsAndCondition}"class="form-control"/>
