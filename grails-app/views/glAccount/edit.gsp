		...
		<div id="edit-glAccount" class="content scaffold-edit" role="main">
            ...
            <content tag="main-actions">
                <ul>
                    ...
                    <li><g:actionSubmit class="save" form="update" action="update" value="${message(code: 'default.button.update.label', default: 'Update')}" onclick="
                            alertify.confirm(AppTitle,'Are you sure you want to continue this transaction?',
                                function(){
                                    checkIfAllowed('GEN00202', 'form#edit', 'Override edit GL Account.', null); 
                                },
                                function(){
                                    return;
                                });                             
