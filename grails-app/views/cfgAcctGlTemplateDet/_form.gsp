...
<div class="fieldcontain form-group ${hasErrors(bean: cfgAcctGlTemplateDetInstance, field: 'glAcct', 'has-error')} ">
	<label class="control-label col-sm-4" for="glAcct">
		<g:message code="cfgAcctGlTemplateDet.glAcct.label" default="Gl Acct" />
		
	</label>
	<div class="col-sm-8"><g:select id="glAcct" name="glAcct.id" from="${icbs.gl.GlAccount.list()}" optionKey="id" optionValue="gl" value="${cfgAcctGlTemplateDetInstance?.glAcct?.id}" class="many-to-one form-control" noSelection="['null': '']"/>
