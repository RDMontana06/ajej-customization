            ...
            <table class="table table-bordered table-rounded table-striped table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td align="center"><g:link action="depEdCollectionProcessing" class="btn btn-primary">Process DepEd Collection</g:link></td>
					</tr> 
                                        
                                        <tr>
						<td>Ajejdrikdrik Loan Collection File Processing</td>
						<td align="center"><g:link action="loanCollectionProcessing" class="btn btn-primary">Process Loan Collection</g:link></td>
					</tr>
