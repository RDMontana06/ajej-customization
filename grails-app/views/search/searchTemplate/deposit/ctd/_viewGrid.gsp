                            ...
                            <g:each in="${domainInstanceList}" status="i" var="domainInstance">   
                                    <tr>
                                        <td>${domainInstance?.ctd?.ctdNo}</td>
                                         ...
                                         <td>
                                              <g:form controller="deposit" action="printCTD" target="_blank">
                                                    <input type="button" class="btn btn-secondary" value="Edit" onclick="editCTD(${domainInstance?.id})"/> 
                                                        <g:hiddenField name="ctdNo" value="${domainInstance?.ctd?.ctdNo}" />
                                                    <g:submitButton class="btn btn-secondary" name="Print" value="Print"/>
                                                </g:form>
                                         </td>
                                    </tr>
                           </g:each>     
