...
<!--                <div id= "addCustomerRelatedError" class="box-body">
            ...
            <g:form name="txnCashWithdrawalForm" action="saveTellerCashWithdrawalTxn" controller="tellering"
                ...
                <script>
                    function validateFieldCashWithdraw(){
                        ...
                        if(passbookBalanceAmount < debitAmtValue){
                            ...
                            var accountNumberrrr = $('#forCheckIfAllowedAcctNo').val();
                            console.log("boom panes: "+accountNumberrrr);

                            alertify.confirm(AppTitle,"Are you sure you want to continue this transaction?",
                            function(){
                                checkIfAllowed($('#txnTemplate option:selected').data('code'), 'form#txnCashWithdrawalForm', 'txnCashWithdrawalOverride@@For Deposit Account No '+accountNumberrrr, $('#depAmt').val()); 
                            },
                            function(){
