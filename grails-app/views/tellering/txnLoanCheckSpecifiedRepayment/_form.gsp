...
<div class="form-group">
    ...
    <div class="col-sm-6">
        <select id="txnTemplate" name="txnTemplate" class="many-to-one form-control">
            ...
            <g:each in="${icbs.admin.TxnTemplate.findAllByTxnType(icbs.lov.TxnType.read(15))}" var="txnTemplateInstance">
        ...
        <div class="infowrap">
            <table class="table table-bordered table-hover table-striped">
                ...
                <tr>
                    ...
                    <td>
                        <g:textField type="number" name="otherAmt" required="" value="${txnLoanCheckSpecifiedRepaymentInstance?.otherAmt}" class="form-control truncated" onchange="updateVar()" disabled="disabled"/>
                    </td>
                </tr>
            </table>
        </div>
