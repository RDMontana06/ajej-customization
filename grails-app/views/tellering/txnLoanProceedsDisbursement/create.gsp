...
<!--            <div id= "addCustomerRelatedError" class="box-body">
            ...
            <g:form name="txnLoanProceedsDisbursementForm" action="saveTellerLoanProceedsDisbursementTxn" 
                controller="tellering" onsubmit="return alertify.alert('Please wait... Processing....')">
        ...
        <content tag="main-actions">
            <script>
                function createnew()
                {
                    ...
                    console.log("TOTAL NET PROCEEDS: "+$('#TotalProceeds').val());
                    ...
                    if(refreshCashOnHand < $('#TotalProceeds').val()){
                        notify.message('Unable to continue transaction. Total Net Proceeds amount cannot be greater than the CASH ON HAND!|error|alert');return; 
                    }                    
