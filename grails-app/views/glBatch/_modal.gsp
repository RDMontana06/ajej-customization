          ...
          <div class="graycontainer">
           ...
           <div v-if=" getAccounts() == '3' " class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" id="amount" class="form-control" v-model="newAmount" number>
              <div class="checkbox">
                <label>
            ...
            <div v-show="breakdown">
              <div class="form-group">
                ...
                <div class="controls col-sm-9">
                  <input type="text" id="amount" class="form-control" v-model="newPrincipal" number>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="controls col-sm-9">
                  <input type="text" id="interest" class="form-control" v-model="newInterest" number>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="controls col-sm-9">
                  <input type="text" id="penalty" class="form-control" v-model="newPenalty" number>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="controls col-sm-9">
                  <input type="text" id="serviceCharge" class="form-control" v-model="newServiceCharge" number>
                </div>
              </div>
            </div>
