...
<div class="fieldcontain form-group">
    ...
    <div class="col-sm-8">
        <g:select name="interestIncomeScheme" from="${InterestIncomeScheme.list()}" optionKey="id" optionValue="name" value="" class="many-to-one form-control" onchange="updateForm()"/>
    </div>
</div>
