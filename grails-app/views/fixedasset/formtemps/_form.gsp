...
<div class="fieldcontain form-group ${hasErrors(bean: bankassetInstance, field: 'asset', 'has-error')} required">
    <label class="control-label col-sm-4" for="asset">
        <g:message code="bankasset.asset.label" default="Asset Type" />
        <span class="required-indicator">*</span>
    </label>
    <div class="col-sm-8"><g:select name="asset" from="${['FFE', 'C&S', 'V&H']}" class="many-to-one form-control"/>

    </div>
</div>

<div class="fieldcontain form-group ${hasErrors(bean: bankassetInstance, field: 'glacc', 'has-error')} required">
    <label class="control-label col-sm-4" for="glacc">
        <g:message code="bankasset.glacc.label" default="Asset Account" />
        <span class="required-indicator">*</span>
    </label>
    <div class="col-sm-8"><g:select id="glacc" name="glacc.id" from="${icbs.gl.GlAccount.findAll{branch.id == 1 && financialYear == 2018}}" optionKey="code" optionValue="name" required="" class="many-to-one form-control"/>
...
<div class="fieldcontain form-group ${hasErrors(bean: bankassetInstance, field: 'creditglacc', 'has-error')} required">
    <label class="control-label col-sm-4" for="creditglacc">
        <g:message code="bankasset.creditglacc.label" default="Accumulated Depreciation Account" />
        <span class="required-indicator">*</span>
    </label>
    <div class="col-sm-8"><g:select id="creditglacc" name="creditglacc.id" from="${icbs.gl.GlAccount.findAll{branch.id == 1 && financialYear == 2018}}" optionKey="code" optionValue="name" required="" class="many-to-one form-control"/>
...
<div class="fieldcontain form-group ${hasErrors(bean: bankassetInstance, field: 'debitglacc', 'has-error')} required">
    <label class="control-label col-sm-4" for="debitglacc">
        <g:message code="bankasset.debitglacc.label" default="Depreciation Expense Account" />
        <span class="required-indicator">*</span>
    </label>
    <div class="col-sm-8"><g:select id="debitglacc" name="debitglacc.id" from="${icbs.gl.GlAccount.findAll{branch.id == 1 && financialYear == 2018}}" optionKey="code" optionValue="name" required="" class="many-to-one form-control"/>
...
<div class="fieldcontain form-group ${hasErrors(bean: bankassetInstance, field: 'vendorlink', 'has-error')} required">
    <label class="control-label col-sm-4" for="vendorlink">
        <g:message code="bankasset.vendorlink.label" default="Vendor" />
        <span class="required-indicator">*</span>
    </label>
    <div class="col-sm-8"><g:field name="vendorlink" id="vendorlink" value="" class="form-control"/>
        <%--<g:select id="vendorlink" name="vendorlink" from="${accounting.fixedasset.Vendor.list(max: 100)}" optionKey="companyname" optionValue="companyname" required=""  class="many-to-one form-control"/>--%>
...
<div class="fieldcontain form-group ${hasErrors(bean: bankassetInstance, field: 'deprevalue', 'has-error')} ">
    ...
    <div class="col-sm-8"><g:field name="deprevalue" value="${fieldValue(bean: bankassetInstance, field: 'deprevalue')}" class="form-control" readonly="readonly" />
...
<div class="fieldcontain form-group ${hasErrors(bean: bankassetInstance, field: 'annualexpense', 'has-error')} ">
    ...
    <div class="col-sm-8"><g:field name="annualexpense" value="${fieldValue(bean: bankassetInstance, field: 'annualexpense')}" class="form-control" readonly="readonly" />
...
<div class="fieldcontain form-group ${hasErrors(bean: bankassetInstance, field: 'monthlyexpense', 'has-error')} ">
    ...
    <div class="col-sm-8"><g:field name="monthlyexpense" value="${fieldValue(bean: bankassetInstance, field: 'monthlyexpense')}" class="form-control" readonly="readonly" />
