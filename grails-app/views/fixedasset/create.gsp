...
<html>
	<head>
		...
		<title>Add New Fixed Asset</title>
	</head>
	<body>
		<content tag="breadcrumbs">
		  <span class="fa fa-chevron-right"></span><a href="${createLink(uri: '/fixedasset')}">Fixed Asset</a>
          <span class="fa fa-chevron-right"></span><span class="current">Create/Update Asset</span>
		</content>
		...
		<div id="create-bankasset" class="content scaffold-create" role="main">
			...
			<g:form id="create" url="[resource:fixedassetInstance, action:'save']" >
				<fieldset class="form">
					<g:render template="/fixedasset/formtemps/form"/>
				</fieldset>
			</g:form>
		</div>
            </content>
            <content tag="main-actions">
                <ul>
                    <li><g:submitButton name="create1" form="create" value="${message(code: 'default.button.create.label', default: 'Create')}" /></li>
