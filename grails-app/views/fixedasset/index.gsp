...
<html>
	...
	<title>Fixed Assets Maintenance</title>
    </head>
    <body>
	<content tag="breadcrumbs">
		...
		<div class="table-responsive">
                    <table class="table table-bordered table-rounded table-striped table-hover">
                        <thead>
                            <tr>
				<th><g:message code="bankasset.assetcode.label" default="Asset Code" /></th>
				<g:sortableColumn property="assetdesc" title="${message(code: 'bankasset.assetdesc.label', default: 'Description')}" />
                                <g:sortableColumn property="purdate" title="${message(code: 'bankasset.purdate.label', default: 'Purchase Date')}" />
                            </tr>
			</thead>
			<tbody>
				...
				<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                                    ...
                                    <td><g:formatDate format="yyyy-MM-dd" date="${bankassetInstance?.purdate}" /></td>
				</tr>
                            </g:each>
			</tbody>
                    </table>
        ...
        <content tag="main-actions">
            <ul>
                <li><g:link class="create" action="create">New Fixed Asset</g:link></li>
            </ul>
        </content>
    </body>
</html>
