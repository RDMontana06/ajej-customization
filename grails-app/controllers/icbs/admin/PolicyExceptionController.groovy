...
class PolicyExceptionController {
    ...
    def index(Integer max) {
        ...
        if (params.query == null) {
            def policyInstance = PolicyException.findAllByRequestingUser(UserMaster.get(session.user_id))
            respond policyInstance, model:[params:params,PolicyExceptionInstanceCount:  PolicyException.count()]
            return
        }
        else{
