...
import icbs.lov.DepositClassification
import icbs.lov.DepositSignatoryRules
...
class Deposit {
    ...
    DepositSignatoryRules depositSignatoryRules
   ...
   //GL Acct Orig
    ...
    def beforeUpdate(){
        ...
        if (this.depositInterestScheme.isGraduated) {
        ...
        if (this.type.id == 3) {
            ...
            if (this.currentRollover) {
                this.maturityDate = this.currentRollover.endDate
            }
        }
    }
}
